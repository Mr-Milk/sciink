...
fn comment_tails_are_condensed_and_overflows_truncated() {
    ...
    // warnings. `s` is an empty leaf with nothing after it, so its surplus x is dropped silently.
